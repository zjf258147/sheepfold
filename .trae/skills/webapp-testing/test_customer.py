...
with sync_playwright() as p:
    ...
    add_btn = page.locator('button:has-text("新增客户")')
    ...
    print("[OK] Dialog opened with contract divider")
    ...
    page.screenshot(path="customer_test.png", full_page=True)
    print("[OK] Screenshot saved")

    browser.close()
    print("\n=== Customer page verification PASSED ===")