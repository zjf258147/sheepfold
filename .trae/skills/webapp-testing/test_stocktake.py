...
with sync_playwright() as p:
    ...
    add_btn = page.locator('button:has-text("创建盘点")')
    ...
    page.screenshot(path="stocktake_test.png", full_page=True)
    print("[OK] Screenshot saved")

    browser.close()
    print("\n=== Stocktake page verification PASSED ===")