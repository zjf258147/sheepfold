...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'shipment', name: 'Shipment', component: () => import('@/views/Shipment.vue'), meta: { title: '出货管理' } },
      { path: 'bom', name: 'BOM', component: () => import('@/views/BOM.vue'), meta: { title: 'BOM管理' } },
      { path: 'production-task', name: 'ProductionTask', component: () => import('@/views/ProductionTask.vue'), meta: { title: '生产任务' } },
      ...
      { path: 'station', name: 'Station', component: () => import('@/views/Station.vue'), meta: { title: '场站管理' } },
      { path: 'device-ledger', name: 'DeviceLedger', component: () => import('@/views/DeviceLedger.vue'), meta: { title: '设备台账' } },
      { path: 'stocktake', name: 'Stocktake', component: () => import('@/views/Stocktake.vue'), meta: { title: '盘点管理' } },
      { path: 'adjustment', name: 'InventoryAdjustment', component: () => import('@/views/InventoryAdjustment.vue'), meta: { title: '库存调整' } },
