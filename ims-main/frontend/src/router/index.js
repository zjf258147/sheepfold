...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'inbound', name: 'Inbound', component: () => import('@/views/Inbound.vue'), meta: { title: '入库', roles: ['ADMIN', 'WAREHOUSE', 'QUALITY', 'PRODUCTION'] } },
      { path: 'inbound/:id', name: 'InboundDetail', component: () => import('@/views/InboundDetail.vue'), meta: { title: '入库单详情', roles: ['ADMIN', 'WAREHOUSE', 'QUALITY', 'PRODUCTION'] } },
      ...
      { path: 'outbound', name: 'Outbound', component: () => import('@/views/Outbound.vue'), meta: { title: '出库', roles: ['ADMIN', 'WAREHOUSE', 'QUALITY', 'PRODUCTION'] } },
      { path: 'outbound/:id', name: 'OutboundDetail', component: () => import('@/views/OutboundDetail.vue'), meta: { title: '出库单详情', roles: ['ADMIN', 'WAREHOUSE', 'QUALITY', 'PRODUCTION'] } },
      {
        path: 'snapshot',
      ...
      { path: 'device-ledger', name: 'DeviceLedger', component: () => import('@/views/DeviceLedger.vue'), meta: { title: '设备台账', roles: ['ADMIN', 'WAREHOUSE', 'TEST_ENGINEER'] } },
