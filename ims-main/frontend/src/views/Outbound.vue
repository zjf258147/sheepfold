  ...
  <el-card shadow="never">
    <el-form :inline="true" class="list-search" @submit.prevent="searchOrders">
      ...
      <el-form-item>
        ...
        <PermissionButton permKey="outbound.create" tip="仅仓库管理员可创建出库单">
      ...
      <el-table-column label="操作" min-width="168" align="center">
        <template #default="{ row }">
          <div class="row-actions">
            ...
            <PermissionButton permKey="outbound.edit">
            ...
            <PermissionButton permKey="outbound.submit">
            ...
            <PermissionButton permKey="outbound.approve">
            ...
            <PermissionButton permKey="outbound.cancel">
